...
function addInput(divName, placeholder)
{
	...
	newDiv.innerHTML = "<input type='text' placeholder='"+ placeholder + "'name='" + divName + "'>";
...
{
	var newdiv = document.createElement('div');
	newdiv.innerHTML = "<textarea  placeholder='"+ placeHolder + " " + stepCounter + "'name='" + divName + "'></textarea>";
	document.getElementById(divName).appendChild(newdiv);
	stepCounter++;
}
